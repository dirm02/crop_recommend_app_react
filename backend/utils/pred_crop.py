...
def get_prediction(x):
    ...
    model.load_state_dict(torch.load('backend/model/baseline/baseline.hdf5'))
    normalization = np.load("backend/model/normalization/normalization.npz")
    ...
    with open("backend/model/pkl_files/encoder.pkl", "rb") as file:
